		...
		<div class="container-menu-header-v3">
			<div class="wrap_header3 p-t-74">
				...
				<a href="index.html" class="logo3">
					<img src="/resources/vendor/template-customer/images/icons/logo.png" alt="IMG-LOGO">
				</a>

				<!-- Header Icon -->
				<div class="header-icons3 p-t-38 p-b-60 p-l-8">
					<a href="/customer/login" class="header-wrapicon1 dis-block">
						<img src="/resources/vendor/template-customer/images/icons/icon-header-01.png" class="header-icon1" alt="ICON">
					</a>

					<span class="linedivide1"></span>

					<div class="header-wrapicon2">
						<img src="/resources/vendor/template-customer/images/icons/icon-header-02.png" class="header-icon1 js-show-header-dropdown" alt="ICON">
							...
							<ul class="header-cart-wrapitem">
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="/resources/vendor/template-customer/images/item-cart-01.jpg" alt="IMG">
									</div>
								...
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="/resources/vendor/template-customer/images/item-cart-02.jpg" alt="IMG">
									</div>
								...
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="/resources/vendor/template-customer/images/item-cart-03.jpg" alt="IMG">
									</div>
